...
public class StoreRecommandRVAdapter extends RecyclerView.Adapter<StoreRecommandRVAdapter.ViewHolder> {
    ...
    public StoreRecommandRVAdapter(Context context, String[] eventTitle, String[] eventPrice, int[] imgList) {
